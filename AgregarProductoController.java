...
public class AgregarProductoController implements Initializable {
    ...
    @FXML
    private ComboBox<String>comboGluten,comboTipoPlato;
    
    @FXML
    private TextField entradaCodigo,entradaNombre, entradaPorciones, entradaPrecio;
    ...
    public void capturaDatos() {
        ...
        codigo = entradaCodigo.getText();
        
        if (LaPodasaDeLosBrujos.buscarProducto(codigo) == null) {
            if (seleccionComboLibreGluten == null) {
                ...
                switch (seleccionCompoTipoPlato) {
                    case "Plato Fuerte":
                        ...
                        while (contador <= MIN_INGREDIENTES || continuar) {
                            ...
                            if (resultado.isPresent() && !resultado.get().trim().isEmpty()) {
                                ...
                                if (contador > MIN_INGREDIENTES) {
                                    ...
                                    //Retroalimentacion para el usuario para que ponga numeros enteros o con decimales
                                    Alert errorIngredientes = new Alert(AlertType.WARNING);
                        ...
                        PlatoFuerte nuevoPlatoFuerte = new PlatoFuerte(codigo, nombre, libreGluten, cantidadPorciones, precio, ingredientes);
                        LaPodasaDeLosBrujos.agregarProducto(nuevoPlatoFuerte);
                        System.out.println("Se agregó este plato fuerte: " + nuevoPlatoFuerte);

                        //Se informa al usuario que el postre se guardó exitosamente
                        Alert alerta = new Alert(AlertType.INFORMATION);
                        alerta.setTitle("¡Éxito!");
                        alerta.setHeaderText("Postre agregado exitosamente");
                        alerta.showAndWait();
                    ...
                    case "Postre":
                        ...
                        try {
                            ...
                            //Retroalimentación para el usuario para que ponga porciones en numeros enteros
                            Alert errorPorcion = new Alert(AlertType.WARNING);
                        ...
                        try {
                            ...
                            //Retroalimentacion para el usuario para que ponga numeros enteros o con decimales
                            Alert errorPrecio = new Alert(AlertType.WARNING);
                        ...
                        if ("Sí".equals(seleccionComboLibreGluten)) {
                            ...
                            //Retroalimentacion del usuario para que indique si el platillo tiene o no gluten
                            Alert errorGluten = new Alert(AlertType.WARNING);
                        ...
                        LaPodasaDeLosBrujos.agregarProducto(nuevoPostre);
                        System.out.println("Se agregó este postre: " + nuevoPostre);

                        //Se informa al usuario que el postre se guardó exitosamente
                        Alert exito = new Alert(AlertType.INFORMATION);
                        exito.setTitle("¡Éxito!");
                        exito.setHeaderText("Postre agregado exitosamente");
                        exito.showAndWait();
            ...
            Alert alerta = new Alert(AlertType.WARNING);
            alerta.setTitle("¡Atención!");
            alerta.setHeaderText("Ese codigo de producto ya se encuentra en el menu, por favor utilize otro codigo");
            alerta.showAndWait();
        }
    }
}